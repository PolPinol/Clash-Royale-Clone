...
/**
 * Class RoundJPassword. This is a class with the objective to customize the JPasswordField.
 */
public class RoundJPassword extends JPasswordField {
    ...
    /**
     * Instantiates a new RoundJPassword.
     *
     * @param text the text
     */
    public RoundJPassword(String text) {
